Function New-LaunchScriptLFD2serverPS {
    ...
    ((Get-Content -path $global:currentdir\$global:server\left4dead2\cfg\server.cfg -Raw) -replace "\bADMINPASSWORD\b","$global:RCONPASSORD") | Set-Content -Path $global:currentdir\$global:server\left4dead2\cfg\server.cfg
