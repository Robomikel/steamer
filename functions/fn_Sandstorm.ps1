Function New-LaunchScriptInssserverPS {
        ...
        #Add-Content -Path $global:currentdir\$global:server\Launch-$global:server.ps1 -Value "Start-Process -FilePath C:\Users\insserver\sandstorm\InsurgencyServer.exe -ArgumentList (`"${global:MAP}?Scenario=${global:SCENARIO}?MaxPlayers=${global:MAXPLAYERS} -Port=${global:PORT} -QueryPort=${global:QUERYPORT} -log -hostname=${global:HOSTNAME}`")"
